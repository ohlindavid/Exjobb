function [SS,MSS,TI,FI,H]=screassignspectrogram(X,c,NFFT,NSTEP,Fs,e);

% SCREASSIGNSPECTROGRAM [SS,MSS,TI,FI,H]=screassignspectrogram(X,c,NFFT,NSTEP,Fs,e); 
...
%
% X:    Data sequence 
% c:    Parameter of Gaussian window.
...
if nargin<2
    'Error: No data or window length input'
end
if nargin<6
   e=0;
end
...
Hl=12*c; %Long enough window
H=exp(-0.5*([-Hl/2:Hl/2-1]'/c).^2);
