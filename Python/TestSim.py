...
def path():
    ...
    if who=="David":
        return "C:/Users/david/Documents/GitHub/exjobb/Testing Sets/Simulated/snr2/"
def pathPred():
    if who=="Oskar":
        return "C:/Users/Oskar/Documents/GitHub/exjobb/Testing Sets/Albin&Damir/AD_data_set_subject_6/"
    if who=="David":
        return "C:/Users/david/Documents/GitHub/exjobb/Testing Sets/Simulated/snr2test/"
...
#        list_names = np.repeat(list_names,2)
    ...
    data_generatorTest = signalLoader(nchan,val_list_names,val_list_labels,pathPred())
