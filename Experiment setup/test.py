...
trials = data.TrialHandler(nReps=50, method='random', 
    ...
    trialList=data.importConditions('conditionsTest.csv', selection='1:2'),
...
for thisTrial in trials:
    ...
    trialComponents = [text, image, image2, text2]
